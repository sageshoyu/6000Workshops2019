...
public class Constants {
   ...
   //Elevator
   public static final double kELEV_LOW_HEIGHT = 0.02;
   public static final double kELEV_MID_HEIGHT = 0.3556;
   public static final double kELEV_HIGH_HEIGHT = 0.6096;
    ...
    public static final double kDRIVE_WHEEL_RADIUS = 0.01524; // in m
    ...
    public static final double kDRIVE_LEFT_Kf = 12.0/11.0;  //MEASURE ME in V/(m/s) 
    public static final double kDRIVE_RIGHT_Kf = 12.0/11.0; 
